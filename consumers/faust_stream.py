...
# It isn't compatible with Python 3.10 https://github.com/robinhood/faust/issues/748
...
async def station(stations):
    ...
    async for station in stations:
        ...
        # transformed_station - table[station.station_id]
        table[station.station_id]  = TransformedStation(station_id=station.station_id, 
                                                 station_name=station.station_name, 
                                                 order=station.order,
                                                 line=line)

    # await out_topic.send(value=table[station.station_id])                                                 
